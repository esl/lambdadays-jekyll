...
*   [Other events](#)
 ...
 [![](/static/img/github.png)](http://www.github.com/DoomHammer) [![](/static/img/twitter.png)](http://www.twitter.com/DoomHammerNG) 
...
Functional programming is most prolific on the backend. There's no shortage of front-end solutions as well, with Elm being one of the most recognized. What about the rest of the stack then? One exciting application of functional programming in the system space is the Nix package manager. That's right, purely functional package management without side effects. Curious? Join the presentation!

  
[Video](https://www.youtube.com/watch?v=6AvwC25fd_U&list=PLvL2NEhYV4ZsV9Bw0wp1P46SOdtk4pFW6&index=18&t=0s) [←Back](/lambdadays2020)
