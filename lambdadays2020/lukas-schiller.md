...
PhD Student at Philipps-Universität Marburg  

Lukas is a PhD student at the University of Marburg.  
His research revolves around the Eden programming language, a parallel Haskell dialect.

#### Placement Strategies: Structured Skeleton Composition with Location Aware Remote Data

Of all the different approaches to parallel programming the concept of algorithmic skeletons is one of the most promising. In this talk we will extend Eden's algorithmic skeletons with Placement Strategies: higher-order functions to organize coordination of parallel computation placement.

[Slides](https://lambdadays-prod.s3.amazonaws.com/presentations/lukas+Schiller+-+skeleton_composition(1).pdf)  
[Video](https://www.youtube.com/watch?v=AC-0VGn77sE&list=PLvL2NEhYV4ZsV9Bw0wp1P46SOdtk4pFW6&index=35&t=0s) [←Back](/lambdadays2020)
