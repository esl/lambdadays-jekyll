...
Assistant Professor at EPITA Research Lab  

Jim is an assistant professor at [EPITA](https://epita.fr) [Research Lab](https://lrde.epita.fr) and long time Lisp programmer (Common Lisp and other Lisp dialects, SKILL++ in particular). [Recent work](https://www.lrde.epita.fr/wiki/User:Jnewton) includes extending the Common Lisp type system to support [heterogeneous sequence types](https://www.lrde.epita.fr/wiki/Publications/newton.18.phd). This work combines several research topics: Dynamic Languages, Symbolic Finite Automata, Binary Decision Diagrams, and Meta-Programming.
...
[Video](https://www.youtube.com/watch?v=gRV8YW-wqkc&list=PLvL2NEhYV4ZsV9Bw0wp1P46SOdtk4pFW6&index=43&t=0s) [←Back](/lambdadays2020)
